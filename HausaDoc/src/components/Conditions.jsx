...
//       setError("");
//       try {
//         const response = await fetch("http://localhost:5000/medlineplus/conditions");
...
//             <span className="mt-4 text-blue-900 font-semibold">Loading conditions...</span>
//           </div>
//         )}
...
//                   {/* Split the summary into bullets by sentence */}
