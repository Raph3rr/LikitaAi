...
// useEffect(() => {
//   setHomeTips(homeCareTips.slice(0, 10)); // show 10 random tips initially
// }, []);



//   // Helper: shuffle & take n items
//   const getRandomTips = (arr, n) => {
...
//       facilities.filter(f => f.state?.toLowerCase().includes(query))
//     );
//   }}
// />
...
//       <div key={idx} className="p-3 bg-gray-50 rounded shadow-sm">
//         <h4 className="font-semibold text-green-700">{f.name || f.facility_name}</h4>
//         <p className="text-sm text-gray-600">{f.state}, {f.lga}</p>
